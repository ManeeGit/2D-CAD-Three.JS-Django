(function webpackUniversalModuleDefinition(root, factory) {
    ...
    else if (typeof exports === "object") exports["dat"] = factory();
    else root["dat"] = factory();
})(this, function() {
    ...
    /******/ }([
        /* 0 */ /***/ function(module1, exports1, __webpack_require__) {
            ...
            exports1.default = _index2.default; /**
	 ...
	 */ exports1.default = {
        ...
        /* 2 */ /***/ function(module1, exports1, __webpack_require__) {
            ...
            Color.recalculateRGB = function(color, component, componentHexIndex) {
                if (color.__state.space === "HEX") color.__state[component] = _math2.default.component_from_hex(color.__state.hex, componentHexIndex);
                else if (color.__state.space === "HSV") _common2.default.extend(color.__state, _math2.default.hsv_to_rgb(color.__state.h, color.__state.s, color.__state.v));
            ...
            Color.recalculateHSV = function(color) {
                ...
                if (!_common2.default.isNaN(result.h)) color.__state.h = result.h;
                else if (_common2.default.isUndefined(color.__state.h)) color.__state.h = 0;
            };
            Color.COMPONENTS = [
                "r",
                "g",
	 ...
	 */ var INTERPRETATIONS = [
                ...
                // Objects
                {
                    ...
                    conversions: {
                        RGBA_OBJ: {
                            read: function read(original) {
                                if (_common2.default.isNumber(original.r) && _common2.default.isNumber(original.g) && _common2.default.isNumber(original.b) && _common2.default.isNumber(original.a)) return {
                                    space: "RGB",
                                    r: original.r,
                                    g: original.g,
                                    b: original.b,
                        ...
                        RGB_OBJ: {
                            read: function read(original) {
                                if (_common2.default.isNumber(original.r) && _common2.default.isNumber(original.g) && _common2.default.isNumber(original.b)) return {
                                    space: "RGB",
                                    r: original.r,
                                    g: original.g,
                                    b: original.b
                        ...
                        HSVA_OBJ: {
                            read: function read(original) {
                                if (_common2.default.isNumber(original.h) && _common2.default.isNumber(original.s) && _common2.default.isNumber(original.v) && _common2.default.isNumber(original.a)) return {
                                    space: "HSV",
                                    h: original.h,
                                    s: original.s,
                                    v: original.v,
                        ...
                        HSV_OBJ: {
                            read: function read(original) {
                                if (_common2.default.isNumber(original.h) && _common2.default.isNumber(original.s) && _common2.default.isNumber(original.v)) return {
                                    space: "HSV",
                                    h: original.h,
                                    s: original.s,
                                    v: original.v
            ...
            exports1.default = interpret;
            module1.exports = exports1["default"];
        /***/ },
        /* 4 */ /***/ function(module1, exports1) {
            "use strict";
            exports1.__esModule = true;
            exports1.default = function(color, forceCSSHex) {
	 ...
	 */ var BooleanController = function(_Controller) {
            ...
            exports1.default = BooleanController;
            module1.exports = exports1["default"];
        /***/ },
	    ...
	    */ 
            ...
            function cssValueToPixels(val) {
                if (val === "0" || _common2.default.isUndefined(val)) return 0;
                var match = val.match(CSS_VALUE_PIXELS);
                if (!_common2.default.isNull(match)) return parseFloat(match[1]);
                // TODO ...ems? %?
                return 0;
            }
            /**
	 ...
	 */ var dom = {
	   ...
	   */ makeFullscreen: function makeFullscreen(elem, hor, vert) {
                    var vertical = vert;
                    var horizontal = hor;
                    if (_common2.default.isUndefined(horizontal)) horizontal = true;
                    if (_common2.default.isUndefined(vertical)) vertical = true;
	 ...
	 */ var OptionController = function(_Controller) {
	     ...
	     */ _this2.__select = document.createElement("select");
            ...
            exports1.default = OptionController;
            module1.exports = exports1["default"];
        /***/ },
	 ...
	 */ var StringController = function(_Controller) {
                ...
                StringController.prototype.updateDisplay = function updateDisplay() {
                    ...
                    if (!_dom2.default.isActive(this.__input)) this.__input.value = this.getValue();
                    return _Controller.prototype.updateDisplay.call(this);
                };
                return StringController;
            }(_Controller3.default);
            exports1.default = StringController;
            module1.exports = exports1["default"];
        /***/ },
	 ...
	 */ var NumberController = function(_Controller) {
                ...
                function NumberController(object, property, params) {
                    ...
                    if (_common2.default.isUndefined(_this.__step)) {
                        if (_this.initialValue === 0) _this.__impliedStep = 1; // What are we, psychics?
	   ...
	   */ NumberController.prototype.step = function step(v) {
            ...
            exports1.default = NumberController;
            module1.exports = exports1["default"];
        /***/ },
	 ...
	 */ var NumberControllerBox = function(_NumberController) {
	     ...
	     */ var prevY = void 0;
                    function onChange() {
                        ...
                        if (!_common2.default.isNaN(attempted)) _this.setValue(attempted);
                    }
                    function onFinish() {
                        if (_this.__onFinishChange) _this.__onFinishChange.call(_this, _this.getValue());
                    }
            ...
            exports1.default = NumberControllerBox;
            module1.exports = exports1["default"];
        /***/ },
	 ...
	 */ var NumberControllerSlider = function(_NumberController) {
            ...
            exports1.default = NumberControllerSlider;
            module1.exports = exports1["default"];
        /***/ },
	 ...
	 */ var FunctionController = function(_Controller) {
            ...
            exports1.default = FunctionController;
            module1.exports = exports1["default"];
        /***/ },
        /* 16 */ /***/ function(module1, exports1, __webpack_require__) {
            ...
            var ColorController = function(_Controller) {
                ...
                ColorController.prototype.updateDisplay = function updateDisplay() {
                    ...
                    if (i !== false) {
                        ...
                        if (mismatch) _common2.default.extend(this.__color.__state, i);
                    }
            ...
            exports1.default = ColorController;
            module1.exports = exports1["default"];
        /***/ },
        /* 17 */ /***/ function(module1, exports1, __webpack_require__) {
            ...
            /** Have we yet to create an autoPlace GUI? */ var autoPlaceVirgin = true;
            /** Fixed position div that auto place GUI's go inside */ var autoPlaceContainer = void 0;
            /** Are we hiding the GUI's ? */ var hide = false;
            /** GUI's which should be hidden */ var hideableGuis = [];
            /**
	 ...
	 */ var GUI = function GUI(pars) {
	   ...
	   */ this.__rememberedObjectIndecesToControllers = [];
                ...
                if (!_common2.default.isUndefined(params.load)) // Explicit preset
                {
                    if (params.preset) params.load.preset = params.preset;
                } else params.load = {
                    preset: DEFAULT_DEFAULT_PRESET_NAME
                };
                if (_common2.default.isUndefined(params.parent) && params.hideable) hideableGuis.push(this);
                // Only root level GUI's are resizable.
                params.resizable = _common2.default.isUndefined(params.parent) && params.resizable;
                if (params.autoPlace && _common2.default.isUndefined(params.scrollable)) params.scrollable = true;
	     ...
	     */ name: {
                        ...
                        set: function set(v) {
                            ...
                            params.name = v;
                            if (titleRowName) titleRowName.innerHTML = params.name;
                        }
                    },
                    /**
	     ...
	     */ closed: {
                        ...
                        set: function set(v) {
                            params.closed = v;
                            if (params.closed) _dom2.default.addClass(_this.__ul, GUI.CLASS_CLOSED);
                            else _dom2.default.removeClass(_this.__ul, GUI.CLASS_CLOSED);
	     ...
	     */ useLocalStorage: {
                        ...
                        set: function set(bool) {
                            if (SUPPORTS_LOCAL_STORAGE) {
                                ...
                                if (bool) _dom2.default.bind(window, "unload", saveToLocalStorage);
                                else _dom2.default.unbind(window, "unload", saveToLocalStorage);
            ...
            _common2.default.extend(GUI.prototype, /** @lends dat.gui.GUI */ {
                /**
	   * @param object
	   * @param property
	   ...
	   */ remove: function remove(controller) {
                ...
                destroy: function destroy() {
                    ...
                    if (this.saveToLocalStorageIfPossible) _dom2.default.unbind(window, "unload", this.saveToLocalStorageIfPossible);
                },
                /**
	   * @param name
                ...
                onResize: function onResize() {
                    ...
                    if (root.scrollable) {
                        ...
                        _common2.default.each(root.__ul.childNodes, function(node) {
                            if (!(root.autoPlace && node === root.__save_row)) h += _dom2.default.getHeight(node);
                        });
                    ...
                    if (root.__resize_handle) _common2.default.defer(function() {
	 ...
	 */ function addRow(gui, newDom, liBefore) {
                    ...
                    options: function options(_options) {
                        if (arguments.length > 1) {
                            ...
                            return _add(gui, controller.object, controller.property, {
                                before: nextSibling,
                                factoryArgs: [
                                    _common2.default.toArray(arguments)
                                ]
                            });
                        }
            ...
            function recallSavedValue(gui, controller) {
                ...
                if (matchedIndex !== -1) {
                    ...
                    if (root.load && root.load.remembered) {
                        ...
                        else if (presetMap[DEFAULT_DEFAULT_PRESET_NAME]) // Uhh, you can have the default instead?
            ...
            function _add(gui, object, property, params) {
                ...
                if (params.color) controller = new _ColorController2.default(object, property);
                else {
                    var factoryArgs = [
                        object,
                        property
                ...
                if (params.before instanceof _Controller2.default) params.before = params.before.__li;
                ...
                if (controller instanceof _ColorController2.default) _dom2.default.addClass(li, "color");
                else _dom2.default.addClass(li, _typeof(controller.getValue()));
            ...
            function addSaveMenu(gui) {
                ...
                if (gui.load && gui.load.remembered) _common2.default.each(gui.load.remembered, function(value, key) {
            ...
            function updateDisplays(controllerArray) {
                if (controllerArray.length !== 0) _requestAnimationFrame2.default.call(window, function() {
	 ...
	 */ module1.exports = {
        ...
        /* 20 */ /***/ function(module1, exports1, __webpack_require__) {
            ...
            var ControllerFactory = function ControllerFactory(object, property) {
                ...
                // Providing options?
                if (_common2.default.isArray(arguments[2]) || _common2.default.isObject(arguments[2])) return new _OptionController2.default(object, property, arguments[2]);
                // Providing a map?
                if (_common2.default.isNumber(initialValue)) {
                    ...
                    if (_common2.default.isNumber(arguments[2]) && _common2.default.isNumber(arguments[3])) {
                        // has step?
                        if (_common2.default.isNumber(arguments[4])) return new _NumberControllerSlider2.default(object, property, arguments[2], arguments[3], arguments[4]);
                        return new _NumberControllerSlider2.default(object, property, arguments[2], arguments[3]);
                    }
                    // number box
                    if (_common2.default.isNumber(arguments[4])) // has step
                ...
                if (_common2.default.isString(initialValue)) return new _StringController2.default(object, property);
                if (_common2.default.isFunction(initialValue)) return new _FunctionController2.default(object, property, "");
                if (_common2.default.isBoolean(initialValue)) return new _BooleanController2.default(object, property);
                return null;
            }; /**
	    * dat-gui JavaScript Controller Library
	    * http://code.google.com/p/dat-gui
	    ...
	    * http://www.apache.org/licenses/LICENSE-2.0
	    */ 
            exports1.default = ControllerFactory;
            module1.exports = exports1["default"];
        /***/ },
	 ...
	 */ function requestAnimationFrame(callback) {
            ...
            exports1.default = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || requestAnimationFrame;
            module1.exports = exports1["default"];
        /***/ },
	   ...
	   */ CenteredDiv.prototype.hide = function hide() {
            ...
            exports1.default = CenteredDiv;
            module1.exports = exports1["default"];
        /***/ },
        /* 23 */ /***/ function(module1, exports1, __webpack_require__) {
            exports1 = module1.exports = __webpack_require__(24)();
            // imports
            // module
            exports1.push([
                module1.id,
            ...
            module1.exports = function() {
                ...
                list.toString = function toString() {
                    ...
                    for(var i = 0; i < this.length; i++){
                        var item = this[i];
                        if (item[2]) result.push("@media " + item[2] + "{" + item[1] + "}");
...
//# sourceMappingURL=circle.19476477.js.map
