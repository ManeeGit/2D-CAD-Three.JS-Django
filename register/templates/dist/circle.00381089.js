...
function redrawGeometryAndUpdateUI(gui, scene, controls, geomFunction) {
    ...
    if (controls.mesh) controls.mesh = changeMat(geomFunction(), controls.mesh.material);
    else controls.mesh = changeMat(geomFunction());
...
function setMaterialGroup(material, group) {
    if (group instanceof THREE.Mesh) group.material = material;
    else if (group instanceof THREE.Group) group.children.forEach(function(child) {
...
//# sourceMappingURL=circle.00381089.js.map
